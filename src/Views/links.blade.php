            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <div class="card">
                        <div class="card-block">
                            <center>
                                <span class="statistic">{{ count($links = HusseinSayed\Links\Models\Link::all()) }}</span><br>
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="card">
                        <div class="card-block">
                            <center>
                                <span class="statistic">{{ count($views = HusseinSayed\Links\Models\View::all()) }}</span><br>
